...
var ZYFILE = {
		...
		// 上传多个文件
		funUploadFiles : function(e, data){
			var self = this;  // 在each中this指向没个v  所以先将this保留
			// 遍历所有文件  ，在调用单个文件上传的方法
			console.log("upload files: ", data);
			$.each(this.uploadFile, function(k, v){
				self.funUploadFile(v,data);
			});
		},
		// 上传单个个文件
		funUploadFile : function(file,data){
			var self = this;  // 在each中this指向没个v  所以先将this保留
		...
		// 初始化
		init : function(data){  // 初始化方法，在此给选择、上传按钮绑定事件
